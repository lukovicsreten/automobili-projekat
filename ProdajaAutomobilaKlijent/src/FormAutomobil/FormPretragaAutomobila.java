...
import models.TableModelAutomobili;

/**
 *
 * @author Sreten
 */
public class FormPretragaAutomobila extends javax.swing.JDialog {

    public FormPretragaAutomobila(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga automobila");
        TableModelAutomobili model = new TableModelAutomobili();
        Thread th = new Thread(model);
        th.start();
        tblAutomobili.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraga (model):");
        ...
        btnDetalji.setText("Detalji automobila");
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        int row = tblAutomobili.getSelectedRow();

        if (row >= 0) {
            Automobil a = ((TableModelAutomobili) tblAutomobili.getModel()).getSelectedAutomobil(row);
            new FormDetaljiAutomobila(this, true, a).setVisible(true);
        }
    ...
    private void btnPretraziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPretraziActionPerformed
        ...
        TableModelAutomobili tm = (TableModelAutomobili) tblAutomobili.getModel();
